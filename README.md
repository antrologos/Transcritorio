...
- **Analisar com AI local** (✨ nada sai do seu computador). Em **qualquer computador**, inclusive sem placa de vídeo: **buscar por sentido** (escreva uma pergunta ou um tema e receba os trechos das entrevistas que tratam disso, mesmo sem as palavras exatas), **temas das entrevistas** (agrupa os trechos por semelhança de sentido, e a partir daí você codifica e exporta para o QualiLab ou para planilha) e **glossário de nomes** do projeto com **revisão de grafias** (a AI encontra "Joao/João/Jono" e você decide, ocorrência por ocorrência, com a grafia certa editável). Com **placa NVIDIA** entram as funções que precisam *escrever*: o **resumo com índice temático** de cada entrevista, a **resposta escrita** citando os trechos e os nomes dos temas dados pela AI. Sem a placa, essas três ficam indisponíveis — o app diz isso antes do clique, e o resto funciona igual.
