...
|---|---|---|
| **Windows 10/11** | `Transcritorio-0.1.3-Setup.exe` | Clique duas vezes no `.exe`. Se tiver placa NVIDIA, o app detecta e oferece a aceleração CUDA opcional (+1 GB). |
...
Barbosa, R. J. (2026). *Transcritório: transcrição local de entrevistas em português brasileiro* (v0.1.3) [Software]. IESP-UERJ/CERES. https://github.com/antrologos/Transcritorio
