...
if exist "%TRANSCRICAO_VENV%\Scripts\python.exe" (
  ...
  "%TRANSCRICAO_VENV%\Scripts\python.exe" -B -m transcribe_pipeline.gui_tk
) else if exist ".venv-transcricao\Scripts\python.exe" (
  set "PATH=%CD%\.venv-transcricao\Scripts;%PATH%"
  ".venv-transcricao\Scripts\python.exe" -B -m transcribe_pipeline.gui_tk
) else (
  python -B -m transcribe_pipeline.gui_tk
)
